...
class _TechnicalState extends State<Technical> {
  var _techCourseData = CourseModel(
          technicalCourseData: [],
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: Obx(() {
      var data = _techCourseData.value.technicalCourseData;
  ...
  void technicalCourse() async {
    _techCourseData.value = (await networkcallService.getCoursesAPICall())!;
  }
}
